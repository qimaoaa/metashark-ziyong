// <copyright file="TvdbModels.cs" company="PlaceholderCompany">
...
public class TvdbSeries
{
    ...
    public Collection<TvdbGenre>? Genres { get; } = new();

    [JsonPropertyName("companies")]
    public Collection<TvdbCompany>? Companies { get; } = new();

    [JsonPropertyName("nameTranslations")]
    public Collection<string>? NameTranslations { get; } = new();

    [JsonPropertyName("overviewTranslations")]
    public Collection<string>? OverviewTranslations { get; } = new();

    [JsonPropertyName("translations")]
    public TvdbTranslations? Translations { get; set; }

    [JsonPropertyName("artworks")]
    public Collection<TvdbArtwork>? Artworks { get; } = new();

    [JsonPropertyName("seasons")]
    public Collection<TvdbSeasonRecord>? Seasons { get; } = new();
}
...
public class TvdbArtwork
{
    ...
    public int Type { get; set; } // 2 = Poster, 12 = Backdrop, 7 = Season Poster
...
public class TvdbEpisodeGroup
{
    ...
    public Collection<TvdbGroupEpisode>? Episodes { get; } = new();
}

public class TvdbGroupEpisode
{
    [JsonPropertyName("name")]
    public string? Name { get; set; }
